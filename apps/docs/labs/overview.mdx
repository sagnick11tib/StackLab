...
<Columns cols={2}>
  ...
  <Card title="Reliability and Operations Lab" href="/labs/reliability-and-operations-lab">
    Deployments, observability, SLOs, incidents, rollbacks, and operational resilience.
  </Card>
  <Card title="Security and Identity Lab" href="/labs/security-and-identity-lab">
